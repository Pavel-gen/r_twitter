...
const FollowerToolBar = ({condition, user, type}) => {
    ...
    return (<>
            <div className='f_container f_comeback  ' >
                <button className='back_btn' onClick={(e)=> {
                e.preventDefault()
        ...
        <div className='f_container extra_list_users' id='f_btn_cont'>
            {condition && <button  id='knownfollowers' className='f_btn' onClick={(e)=> {
                e.preventDefault()
                colorBlind(e)
                navigate(`/profile/${user._id}/knownfollowers`, {replace: true})
            }} >follower you know<div className='button_line hide'></div></button> }
            ...
            >followers<div className='button_line hide'></div></button>
            <button className='f_btn' 
            id='following'
            onClick={(e)=> {
                e.preventDefault()
            ...
            >following<div className='button_line hide'></div></button>
        </div>
    </>)
}
